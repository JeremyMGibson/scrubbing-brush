...
<html>
	...
	<body>
		<!-- Page heading -->
      <div class="page-head">
        <h2 class="pull-left"><i class="fa icon-${domainClass.propertyName}"></i> <g:message code="default.show.label" args="[entityName]" /></h2>
	  ...
	  <div class="matter">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
            	<div id="show-${domainClass.propertyName}" class="widget content scaffold-show" role="main">
